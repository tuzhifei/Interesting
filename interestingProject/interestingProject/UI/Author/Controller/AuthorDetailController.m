...
-(void)setHeadView{
    ...
    _headImageView.frame = CGRectMake(0, kAppNavHeight, ScreenWidth, headHeight);
...
-(void)createNav{
    ...
    self.NavView = [[NavHeadTitleView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, kAppNavHeight)];
    self.NavView.title = @"";
    self.NavView.color = [UIColor whiteColor];
    self.NavView.backTitleImage = @"backImage";
//    self.NavView.rightTitleImage = @"icon_share_n";
...
-(void)setTableView{
    ...
    if (!_tableView) {
        _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, kAppNavHeight, ScreenWidth, ScreenHeight-kAppNavHeight) style:UITableViewStylePlain];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (scrollView.contentOffset.y <= headHeight) {
        self.NavView.headBgView.alpha = scrollView.contentOffset.y/headHeight;
        self.NavView.backTitleImage = @"backImage";
        self.NavView.rightImageView = @"icon_share_n";
        self.NavView.color = [UIColor whiteColor];
        //状态栏字体白色
