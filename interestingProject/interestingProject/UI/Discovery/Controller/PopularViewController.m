...
-(void)setTopUI{
    ...
    UIView *topView = [[UIView alloc]initWithFrame:CGRectMake(0, kAppNavHeight, ScreenWidth, 40)];
...
-(void)setTableView{
    ...
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, kAppNavHeight + 40, ScreenWidth, ScreenHeight - kAppNavHeight - 40) style:UITableViewStylePlain];
