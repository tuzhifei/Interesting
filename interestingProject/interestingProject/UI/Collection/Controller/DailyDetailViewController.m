...
-(void)setUI{
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.width * .8f)];
    [imageView sd_setImageWithURL:[NSURL URLWithString:self.model.ImageView] completed:nil];
    [self.view addSubview:imageView];
    
    UIImageView *playImage = [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth/2 - 35, imageView.height/2 - 35, 70, 70)];
    ...
    UIButton *backBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, kSafeAreaTop + 20 * SCREEN_POINT_375, 30, 30)];
    [backBtn setBackgroundImage:[UIImage imageNamed:@"btn_backdown_normal"] forState:UIControlStateNormal];
    ...
    NSArray *arr = [NSArray arrayWithObjects:
                    ...
                    [UIImage imageNamed:@"btn_download_normal"], nil];
...
-(void)btnClicked{
    ...
    videoPlay.modalPresentationStyle = UIModalPresentationOverFullScreen;
