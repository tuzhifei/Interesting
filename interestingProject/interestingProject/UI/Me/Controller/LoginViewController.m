...
-(void)setUpUI{
    ...
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(60, kSafeAreaTop + 30 * SCREEN_POINT_375, ScreenWidth - 120, 30)];
    ...
    _closeBtn = [[UIButton alloc]initWithFrame:CGRectMake(20, _titleLabel.mj_y, 30, 30)];
    [_closeBtn setBackgroundImage:[UIImage imageNamed:@"audio_AD_close"] forState:UIControlStateNormal];
    ...
    _userName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入手机号" attributes:@{NSForegroundColorAttributeName:[UIColor whiteColor], NSFontAttributeName: [UIFont systemFontOfSize:14]}];
    ...
    _password.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入密码" attributes:@{NSForegroundColorAttributeName:[UIColor whiteColor], NSFontAttributeName: [UIFont systemFontOfSize:14]}];
    ...
    /*
    NSArray *loginArr = [NSArray arrayWithObjects:[UIImage imageNamed:@"share_sina_n"],
                         [UIImage imageNamed:@"share_weixin"],
                         [UIImage imageNamed:@"share_qq"], nil];
    for (int i = 0; i < 3; i ++) {
