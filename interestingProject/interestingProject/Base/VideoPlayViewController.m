...
- (void)viewDidLoad {
    ...
    self.movieView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenHeight, ScreenWidth)];
    ...
    _shadeView.frame = _playerLayer.frame;
...
-(void)setUpControllView{
    ...
    _player.volume = 2;
    _ControlView.frame = CGRectMake(kSafeAreaTop, 0, ScreenHeight - 2 * kSafeAreaTop, ScreenWidth);
    ...
    _backButton.frame = CGRectMake(20 + kSafeAreaTop, 0, 350,50);
    ...
    image.frame = CGRectMake(0, 10, 30, 30);
    [_backButton addSubview:image];
    
    // VideoTitle
    _titleLabel = [[UILabel alloc] init];
    _titleLabel.frame = CGRectMake(image.right + 10 * SCREEN_POINT_375, 10, 400, 30);
